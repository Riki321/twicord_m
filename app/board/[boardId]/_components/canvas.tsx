...
export const Canvas = ({
    ...
    }, [continueDrawing, canvasState, camera, resizeSelectedLayer, translateSelectedLayers, startMultiSelection, updateSelectionNet]);
    ...
    const onPointerUp = useMutation((
        ...
        history.resume();
    }, [setCanvasState, camera, canvasState, history, insertLayer, unselecteLayers, insertPath]);
    ...
    const onLayerPointerDown = useMutation((
        ...
        setCanvasState({ mode: CanvasMode.Translating, current: point });
    }, [setCameraState, camera, history, canvasState.mode]);
